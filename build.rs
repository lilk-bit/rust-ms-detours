...
fn generate_bindings(build: PathBuf) {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .blocklist_type("LPSECURITY_ATTRIBUTES")
        .blocklist_type("LPPROCESS_INFORMATION")
        .blocklist_type("LPSTARTUPINFOA")
        ...
        .raw_line("pub type LPSECURITY_ATTRIBUTES = SECURITY_ATTRIBUTES;")
        .raw_line("pub type LPPROCESS_INFORMATION = PROCESS_INFORMATION;")
        .raw_line("pub type LPSTARTUPINFOA = STARTUPINFOA;")
